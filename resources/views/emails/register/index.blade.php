...
@section('header')
    @include('emails.header', ['headerText' => "¡Hola {$user->full_name}!"])
@endsection
                                ...
                                <td>
                                    <div class="text">
                                        ...
                                        <p
                                          ...
                                          max-width: 500px; 
                                          text-align: center;">
                                            Nos complace darte la bienvenida a nuestra plataforma, diseñada para
                                            facilitar el control de plagas y mejorar la eficiencia de tus
                                            actividades.<br><br><br>

                                            A partir de ahora, podrás utilizar nuestro sistema para crear y administrar
                                            tus órdenes de servicio de manera sencilla y efectiva.</p>
