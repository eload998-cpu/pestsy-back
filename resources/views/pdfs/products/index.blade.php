       ...
       <thead>
            ...
            @foreach($order["products"] as $product)
                <tr>
                    ...
                    <td class="text-center">{{!empty($product["active_ingredient"]) ? $product["active_ingredient"] : "N/A"}}</td>
                    <td class="text-center">{{!empty($product["concentration"]) ? $product["concentration"] : "N/A"}}</td>
                    <td class="text-center">{{!empty($product["dose"]) ? $product["dose"] : "N/A"}}</td>
                    <td class="text-center">{{!empty($product["expiration_date"]) ? \Carbon\Carbon::parse($product['expiration_date'])->format('d/m/y') : "N/A"}}</td>
