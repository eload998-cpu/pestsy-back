                ...
                <tbody>
                    @foreach ($order['rodent_controls'] as $rodent_control)
                        ...
                        <tr style="width:100%">
                            ...
                            <td colspan="2"><b>Nivel de infestación: </b>{{ $rodent_control['infestation_level'] }}
                            </td>
                        </tr>
                        ...
                        <tr style="width:100%">
                            ...
                            <td colspan="2"><b>Técnico responsable: </b>{{ $rodent_control['worker']['full_name'] }}
                            </td>
                            <td colspan="2"><b>Hora aplicación:
                                </b>{{ \Carbon\Carbon::parse($rodent_control['application_time'])->format('h:i A') }}
                            </td>
                        </tr>

                        <tr style="width:100%">
                            <td colspan="6">
                                <b>Tratamiento Aplicado: </b>{{ $rodent_control['application']['name'] }}
                            </td>
                        </tr>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @foreach ($rodent_control['pest_bitacores'] as $pest_bitacore)
                                                <tr>
                                                    <td class="text-center">{{ $pest_bitacore['pest']['common_name'] }}
                                                    </td>
