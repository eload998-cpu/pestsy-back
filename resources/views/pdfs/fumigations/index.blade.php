                    ...
                    @foreach ($order['fumigations'] as $fumigation)
                        ...
                        <tr style="width:100%">
                            ...
                            <td><b>Hora aplicación:
                                </b>{{ \Carbon\Carbon::parse($fumigation['application_time'])->format('h:i A') }}</td>
                            {{-- 1 + 1 + 4 = 6 columns total --}}
                            <td colspan="4"><b>Dentro de límites críticos:
                                </b>{{ $fumigation['within_critical_limits'] ? 'Si' : 'No' }}</td>
                        </tr>
