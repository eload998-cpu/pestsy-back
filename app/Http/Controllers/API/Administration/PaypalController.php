    ...
    public function createSubscriptionForMobile(Request $request)
    {
        try {
            ...
            $subscriptionResponse = $provider->addProductById($plan->paypal_product_id)
                ...
                ->setReturnAndCancelUrl(config('app.front_app_base_url') . '/home/suscripciones/pago/' . $plan->id . '?mobile_status=true', config('app.front_app_base_url') . '/home/suscripciones/pago/' . $plan->id . '?mobile_status=false')
